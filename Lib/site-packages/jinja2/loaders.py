...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'indexold.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/indexold.html'`` the file from the app1 package is loaded,
    by loading ``'app2/indexold.html'`` the file from the second.
    """
